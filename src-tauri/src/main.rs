...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::reconstruct_memory_objects,
            commands::explain_memory_pointer,
            ...
            commands::summarize_exact_calls,
            commands::authorize_exact_call_replay,
            ...
            commands::generate_minimal_evidence_slice,
            commands::inspect_minimal_evidence_slice,
