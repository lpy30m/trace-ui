...
use crate::query::forward_slice::{build_forward_index, traverse_forward_index};
...
impl TraceEngine {
        ...
        F: FnMut(u32, u32) -> bool,
    {
        ...
        let (mut start_indices, normalized_specs, warnings, forward_index, index_reused) = {
        ...
        let Some(mut traversal) = traverse_forward_index(
            &forward_index,
            &start_indices,
            options.data_only,
            max_nodes,
